...
UBUNTU_TRANSLATION_DOMAIN="fullscreenapp.liu-xiao-guo"
...
aptest.commands = bash $$PWD/fullscreenapp/tests/autopilot/run
aptest.depends  = sub-fullscreenapp

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/fullscreenapp/tests/unit 
unittest.depends  = sub-fullscreenapp
